...
namespace BAGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(InputTag_PickUp_Weapon, "InputTag.PickUp.Weapon");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Ability_Hit_Pause, "Player.Ability.HitPause");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Ability_PickUp_Weapon, "Player.Ability.PickUp.Weapon");
	UE_DEFINE_GAMEPLAY_TAG(Player_Ability_Spawn_Axe, "Player.Ability.Spawn.Axe")
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Weapon, "Player.Weapon");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_Continue_Attack, "Player.Event.Continue.Attack")
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_PickUp_Weapon, "Player.Event.PickUp.Weapon");
