...
#include "AI/BTTask_RotateToFace.h"

#include "AIController.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "Kismet/KismetMathLibrary.h"

UBTTask_RotateToFace::UBTTask_RotateToFace()
{
...
void UBTTask_RotateToFace::InitializeFromAsset(UBehaviorTree& Asset)
{
...
uint16 UBTTask_RotateToFace::GetInstanceMemorySize() const
{
...
EBTNodeResult::Type UBTTask_RotateToFace::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	if (HasReachAnglePrecision(OwningPawn, TargetActor))
	{
		Memory->Reset();
...
void UBTTask_RotateToFace::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
	...
	if (HasReachAnglePrecision(Memory->OwningPawn.Get(),Memory->TargetActor.Get()))
	{
		Memory->Reset();
...
bool UBTTask_RotateToFace::HasReachAnglePrecision(APawn* QueryPawn, AActor* TargetActor) const
{
